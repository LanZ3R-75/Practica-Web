  ...
  return (
    <>
      ...
      <section className="mt-8 mb-10">
        <h2 className="text-xl font-semibold mb-2">Contenido Asociado</h2>
        {comercio.contenido ? (
          isEditing ? (
            <>
              <div className="mb-4">
            ...
            <>
              ...
              <p><strong>Resumen:</strong> {comercio.contenido.resumen}</p>
              <button
              ...
              <section className="mt-8">
                <h2 className="text-xl font-semibold mb-2">Consultar Intereses</h2>
                <div className="mt-4">
                <button
